...
void Floresta_Noite::carrega_florestaNoite()
{
	...
	lista_obstaculos.push_back((Obstaculos*) new Fogo(Vector2f(87, 232.5f)));
	lista_obstaculos.push_back((Obstaculos*) new Fogo(Vector2f(-670, 232.5f)));
...
bool Floresta_Noite::executar(vector<Jogador*> lista_players, View & view, RenderWindow & window, MenuPausa & menu)
{
	...
	textura->loadFromFile("imagens\\chefao.png");
	...
	plataformas_view.push_back(new Plataforma(nullptr, Vector2f(3.0f, 1000.0f), Vector2f(-10000.0f, -10000.0f), false));
	Chefao chefe(textura, Vector2u(4, 1), 0.3f, 100.0f, 0, Vector2f(60.0f, 70.0f), Vector2f(-1300.0f, 250.0f), 0);
	Plataforma fimDeFase(nullptr, Vector2f(34.0f, 38.0f), Vector2f(-101528, 346), false);
	...
	while (window.isOpen())
	{
		...
		cout << lista_players[0]->get_posicao().x << endl;
